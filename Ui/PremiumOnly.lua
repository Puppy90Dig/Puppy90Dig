...
local ColorTen = Color3.fromRGB(138, 10, 10)
  ...
  -- [ Components ] --
  Object.HWID = SyncInstance:Create('TextButton', {
    Name = "Reset HWID",
  ...
  Object.RHWID = SyncInstance:Create('TextButton', {
    Name = "Copy HWID",
    Parent = Object.Footer,
    BackgroundColor3 = Color3.fromRGB(45, 45, 45),
    BorderColor3 = Color3.fromRGB(0, 0, 0),
  ...
  -- [ GUI Functions ] --
  Object.HWID.MouseButton1Click:Connect(function()
    Notify.New("[URL Copied to your Clipboard]", 5)
    setclipboard("https://pandadevelopment.net/reset-hwid-premium?service=jupiterhub")
    wait(1)
    Notify.New("[https://pandadevelopment.net/reset-hwid-premium?service=jupiterhub]", 5)
  end)
  Object.RHWID.MouseButton1Click:Connect(function()
    Notify.New("[URL Copied to your Clipboard]", 5)
    setclipboard(game:GetService("RbxAnalyticsService"):GetClientId())
    wait(1)
    Notify.New("[Send this to owner if your reset hwid is on cooldown]", 5)
    wait(1)
    Notify.New(game:GetService("RbxAnalyticsService"):GetClientId(), 5)
  end)
  ...
  Object.HWIDCorner = SyncInstance:Create('UICorner', {
    Parent = Object.HWID,
    CornerRadius = UDim.new(0, 5)
  })
  Object.RHWIDCorner = SyncInstance:Create('UICorner', {
    Parent = Object.RHWID,
    CornerRadius = UDim.new(0, 5)
  })
  ...
  function Login()
    pcall(function()
      ...
      elseif PandaAuth:ValidatePremiumKey(Service, Object.KeyBox.Text) then
        ...
        Notify.New("[" .. Name .. "]: Incorrect Key", 5)
      end
    end)
  end
