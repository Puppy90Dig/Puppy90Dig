...
HoverChange = 0.04
	...
	[51] = function()
		...
		return {
			Name = 'Darker',
			Accent = Color3.fromRGB(247, 200, 163),
			AcrylicMain = Color3.fromRGB(3, 0, 0),
			AcrylicBorder = Color3.fromRGB(60, 60, 60),
			AcrylicGradient = ColorSequence.new(Color3.fromRGB(3, 0, 0), Color3.fromRGB(3, 0, 0)),
			AcrylicNoise = 0.94,
			...
			DropdownFrame = Color3.fromRGB(247, 200, 163),
			DropdownHolder = Color3.fromRGB(3, 0, 0),
			DropdownBorder = Color3.fromRGB(247, 200, 163),
			Dialog = Color3.fromRGB(3, 0, 0),
			DialogHolder = Color3.fromRGB(3, 0, 0),
			DialogHolderLine = Color3.fromRGB(3, 0, 0),
			DialogButton = Color3.fromRGB(3, 0, 0),
